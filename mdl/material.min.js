...
var upgradingEv=createEvent_('mdl-componentupgrading',!0,!0);element.dispatchEvent(upgradingEv);if(upgradingEv.defaultPrevented){return}
...
var upgradedEv=createEvent_('mdl-componentupgraded',!0,!1);element.dispatchEvent(upgradedEv)}}
...
function registerInternal(config){var widgetMissing=(typeof config.widget==='undefined'&&typeof config.widget==='undefined');var widget=!0;if(!widgetMissing){widget=config.widget||config.widget}
...
function deconstructComponentInternal(component){if(component){var componentIndex=createdComponents_.indexOf(component);createdComponents_.splice(componentIndex,1);var upgrades=component.element_.getAttribute('data-upgraded').split(',');var componentPlace=upgrades.indexOf(component[componentConfigProperty_].classAsString);upgrades.splice(componentPlace,1);component.element_.setAttribute('data-upgraded',upgrades.join(','));var ev=createEvent_('mdl-componentdowngraded',!0,!1);component.element_.dispatchEvent(ev)}}
...
window.addEventListener('pageshow',function(e){if(e.persisted){this.element_.style.overflowY='hidden';requestAnimationFrame(function(){this.element_.style.overflowY=''}.bind(this))}}.bind(this),!1);if(this.header_){this.tabBar_=this.header_.querySelector('.'+this.CssClasses_.TAB_BAR)}
...
this.rippleElement_.classList.add(this.CssClasses_.IS_VISIBLE);if(event.type==='mousedown'&&this.ignoringMouseDown_){this.ignoringMouseDown_=!1}else{if(event.type==='touchstart'){this.ignoringMouseDown_=!0}
